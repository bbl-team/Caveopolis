...
public class PurpleSprayCanItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_WALL)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_BRICK_WALL.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_STAIRS)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_BRICK_STAIRS.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_WALL)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_WALL.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_STAIRS)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_STAIRS.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICKS)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_BRICKS.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_SLABS)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_SLAB.get().withPropertiesOf(blockState), 1);
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_SLABS)) {
            ...
            world.setBlock(blockPos, ModBlocks.PURPLE_COLORED_STONE_BRICK_SLAB.get().withPropertiesOf(blockState), 1);
