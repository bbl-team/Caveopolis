...
public class BlackSprayCanItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_WALL)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_BRICK_WALL.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_STAIRS)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_BRICK_STAIRS.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_WALL)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_WALL.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_STAIRS)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_STAIRS.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICKS)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_BRICKS.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_SLABS)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_SLAB.get().withPropertiesOf(blockState));
        ...
        if (blockState.is(ModTags.Blocks.COLORED_STONE_BRICK_SLABS)) {
            ...
            world.setBlockAndUpdate(blockPos, ModBlocks.BLACK_COLORED_STONE_BRICK_SLAB.get().withPropertiesOf(blockState));
